    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-xs rise-in">
        <div className="text-center mb-8">
          <div className="mx-auto mb-3 w-14 h-14 rounded-2xl bg-awning text-white flex items-center justify-center">
            <Store size={26} />
          </div>
          <h1 className="font-display font-bold text-2xl">تسجيل الدخول</h1>
        </div>
        ...
        <p className="text-center text-sm text-inkfaint mt-6">
          ليس لديك حساب؟{' '}
          <Link to="/signup" className="text-awning font-bold hover:underline">
            سجل الآن
          </Link>
        </p>
      </div>
